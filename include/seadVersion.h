...
/// SEAD_ARCHIVERES_TRYGETFILEPATH
///     Add tryGetFilePathImpl_() to sead::ArchiveRes
/// SEAD_ARCHIVERES_ISEXISTFILEIMPL
...
#elif SEAD_VERSION == SEAD_VERSION_SPL2
#define SEAD_SAFESTRING_NONVIRTUAL 0
#define SEAD_RESOURCEMGR_TRYCREATE_NO_FACTORY_NAME 0
#define SEAD_CRITICALSECTION_PURE 0
#define SEAD_THREADMGR_MOVED_SINGLETON_DISPOSER 0
...
#if SEAD_ARCHIVERES_ISCONST
#define SEAD_ARCHIVERES_CONST_TOKEN const
#else
#define SEAD_ARCHIVERES_CONST_TOKEN
#endif
